catch {TE::UTILS::te_msg TE_BD-0 INFO "This block design tcl-file was generate with Trenz Electronic GmbH Board Part:trenz.biz:tef1001_160_2i:part0:1.0, FPGA: xc7k160tfbg676-2 at 2019-07-23T11:53:55."}
...
proc create_hier_cell_pcie { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_pcie_0/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins S_AXI_CTL] [get_bd_intf_pins axi_pcie_0/S_AXI_CTL]

  # Create port connections
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins axi_aclk_out] [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins rst_axi_pcie_0_62M/slowest_sync_clk]
  ...
  connect_bd_net -net pcie_rst_n [get_bd_pins ext_reset_in] [get_bd_pins rst_axi_pcie_0_62M/ext_reset_in]
  connect_bd_net -net reset_rtl_1 [get_bd_pins PCI_PERSTN] [get_bd_pins rst_axi_pcie_0_62M/aux_reset_in]
  connect_bd_net -net rst_axi_pcie_0_62M_interconnect_aresetn [get_bd_pins interconnect_aresetn] [get_bd_pins rst_axi_pcie_0_62M/interconnect_aresetn]
...
proc create_hier_cell_ddr { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_pcie_0_M_AXI [get_bd_intf_pins S02_AXI] [get_bd_intf_pins axi_interconnect_ddr/S02_AXI]
  ...
  # Create port connections
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins S02_ACLK] [get_bd_pins axi_interconnect_ddr/S02_ACLK]
  ...
  connect_bd_net -net rst_axi_pcie_0_62M_interconnect_aresetn [get_bd_pins S02_ARESETN] [get_bd_pins axi_interconnect_ddr/S02_ARESETN]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_pcie_0_M_AXI [get_bd_intf_pins ddr/S02_AXI] [get_bd_intf_pins pcie/M_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI] [get_bd_intf_pins pcie/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI] [get_bd_intf_pins pcie/S_AXI_CTL]
  ...
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins ddr/S02_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins pcie/axi_aclk_out]
  connect_bd_net -net axi_pcie_0_axi_ctl_aclk_out [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins pcie/axi_ctl_aclk_out]
  ...
  connect_bd_net -net pcie_rst_n [get_bd_pins pcie/ext_reset_in] [get_bd_pins vio/probe_out2]
  connect_bd_net -net reset_rtl_1 [get_bd_ports PCI_PERSTN] [get_bd_pins pcie/PCI_PERSTN]
  connect_bd_net -net rst_axi_pcie_0_62M_interconnect_aresetn [get_bd_pins ddr/S02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins pcie/interconnect_aresetn]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x80000000 [get_bd_addr_spaces pcie/axi_pcie_0/M_AXI] [get_bd_addr_segs ddr/mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x20000000 [get_bd_addr_spaces sys_mb/microblaze_0/Data] [get_bd_addr_segs pcie/axi_pcie_0/S_AXI/BAR0] SEG_axi_pcie_0_BAR0
  create_bd_addr_seg -range 0x10000000 -offset 0x10000000 [get_bd_addr_spaces sys_mb/microblaze_0/Data] [get_bd_addr_segs pcie/axi_pcie_0/S_AXI_CTL/CTL0] SEG_axi_pcie_0_CTL0
